...
/**
 * Storage abstraction for needle persistence. This interface defines the contract for storing
 * and retrieving needles, allowing different implementations (DataStore, Room, etc.).
 *
