...
class NeedleGeneratorService(
    ...
    private fun parseNeedleType(typeString: String): Needle.Arg.Type {
        return when (typeString.lowercase()) {
            "string" -> Needle.Arg.Type.String
            "int",
            "integer" -> Needle.Arg.Type.Int

            "float",
            "double" -> Needle.Arg.Type.Float

            "boolean",
            "bool" -> Needle.Arg.Type.Boolean

            "image" -> Needle.Arg.Type.Image
            "any" -> Needle.Arg.Type.Any
            else -> Needle.Arg.Type.String // Default to String
        }
    }
