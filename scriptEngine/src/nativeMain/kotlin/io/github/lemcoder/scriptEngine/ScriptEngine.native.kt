    ...
    override fun registerFunction(name: String, fn: ScriptFunction) {
        ...
        val cFunction = staticCFunction { luaState: CPointer<lua_State>? ->
            ...
            try {
                ...
                val fnRef =
                    lua_touserdata(luaState, LuaMacros.lua_upvalueindex(1))
                        ?.asStableRef<ScriptFunction>() ?: return@staticCFunction 0
                ...
                val result = runBlocking { kotlinFunction.invoke(args) }
