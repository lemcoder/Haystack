...
@Composable
fun DownloadModelScreen(state: DownloadModelState, onEvent: (DownloadModelEvent) -> Unit) {
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Text(
                                text =
                                    "To get started, we need to download the local AI model. This only needs to be done once.",
                    ...
                    Button(
                        ...
                        Text(
                            text =
                                if (state.isDownloading) "Downloading Model..."
                                else "Download Model",
