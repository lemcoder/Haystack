...
class NeedleGeneratorService(
    ...
    suspend fun generateNeedle(functionalityDescription: String): Result<Needle> {
        return withContext(Dispatchers.IO) {
            try {
                ...
                val strategy = functionalStrategy<String, String>("needle-generator") { input ->
    ...
    private fun createGenerationPrompt(functionalityDescription: String) = prompt(
        "needle-generator"
    ) {
        system(
            """
    ...
    private fun parseNeedleType(typeString: String): NeedleType {
        return when (typeString.lowercase()) {
            ...
            "int", "integer" -> NeedleType.Int
            "float", "double" -> NeedleType.Float
            "boolean", "bool" -> NeedleType.Boolean
    ...
    companion object {
        ...
        val Instance: NeedleGeneratorService by lazy {
            NeedleGeneratorService()
        }
    }
}
