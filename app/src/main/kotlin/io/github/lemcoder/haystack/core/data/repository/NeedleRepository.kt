...
private val Context.needlesDataStore: DataStore<Preferences> by
  preferencesDataStore(name = "needles")
...
class NeedleRepositoryImpl(private val context: Context = App.context) : NeedleRepository {
  ...
  override suspend fun deleteAllNeedles() {
    context.needlesDataStore.edit { preferences -> preferences.remove(NEEDLES_KEY) }
  }
