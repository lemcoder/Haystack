...
/**
 * Helper class for formatting Kotlin values to Python code strings. Handles type conversion for
 * needle argument injection.
 */
object PythonValueFormatter {
  ...
  /**
   * Formats a string value with proper Python escaping. Uses triple quotes for multi-line support.
   */
  ...
  /** Formats a value of unknown/any type. Best-effort conversion to Python. */
