...
@Composable
fun NeedleGeneratorScreen(state: NeedleGeneratorState, onEvent: (NeedleGeneratorEvent) -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
            ...
            Column(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text =
                                "Describe the functionality you want, and AI will generate a complete Needle with Python code, arguments, and descriptions.",
                ...
                OutlinedTextField(
                    ...
                    onValueChange = {
                        onEvent(NeedleGeneratorEvent.UpdateFunctionalityDescription(it))
                    },
                    label = { Text("Describe the Functionality") },
                    placeholder = {
                        Text(
                            "e.g., Calculate the factorial of a number, Get current weather for a city, Generate a random password with custom length"
                        )
                    },
                    modifier = Modifier.fillMaxWidth(),
                    minLines = 5,
                ...
                Button(
                    ...
                    Text(
                        text =
                            if (state.isGenerating) "Generating Needle..." else "Generate Needle",
