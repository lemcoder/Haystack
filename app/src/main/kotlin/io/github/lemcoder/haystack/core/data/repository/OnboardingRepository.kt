...
class OnboardingRepositoryImpl(private val context: Context = App.context) : OnboardingRepository {
  ...
  override suspend fun markSampleNeedlesAdded() {
    context.onboardingDataStore.edit { preferences -> preferences[DID_ADD_SAMPLE_NEEDLES] = true }
  }
